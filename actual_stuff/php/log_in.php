...
if (isset($results)) {
    ...
    if ($results[2]) {
        ...
        $_SESSION["engineer"] = $_REQUEST['email'];
        $_SESSION["admin"] = "admin";
        $_SESSION["engineer_id"] =
            mysqli_fetch_row(mysqli_query($database, "SELECT Engineer_ID FROM Engineers WHERE Username = '{$_SESSION['engineer']}';"))[0] or die($database->error);
        // var_dump($_SESSION);
